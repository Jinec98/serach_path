...
void SerachPath::initWindow()
{
	...
	infoText += "由于迷宫的大小规模未知，窗口界面大小为公式计算得出，因此在迷宫规模为5*5-30*30下程序显示最佳。\n";
	infoText += "如若是第一次运行本程序，建议先点击“帮助”了解程序的相关操作。\n\n";
	infoText += "本程序开发耗时一周，若出现诸多问题敬请谅解！\n";
	infoText += "如遇BUG可与我联系╮(﹀_﹀)╭\n\n\n";
...
void SerachPath::helpActionSlot()
{
	...
	infoText += "本程序须知：\n\n";
	infoText += "1、点击“打开文件”\t打开“.txt”文本文件\n\n";
